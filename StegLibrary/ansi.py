# This script implements an ANSI formatter for supported platforms. The
# formatter helps streamlining the process of colouring "print" statements.
#
# The only unique static method of the formatter can be used in place of the
# usual print() function, by overwriting:
